...
namespace WebClient.Services
{
    public class ExamService : IExamService
    {
        ...
        public async Task<RequestResponse> ImportExamsFromExcel(IBrowserFile file)
        {
            ...
            try
            {
                ...
                var fileStream = file.OpenReadStream(maxAllowedSize: 10 * 1024 * 1024); // Adjust max size as needed
                var streamContent = new StreamContent(fileStream);
                content.Add(streamContent, "file", file.Name); // Name 'file' matches the parameter in your API
