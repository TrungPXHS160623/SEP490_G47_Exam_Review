...
public partial class QuizManagementContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Report>().HasData(
            ...
            new Report { ReviewId = 2, ExamId = 2, UserId = 7, ReportContent = "In PRN211, question 2 has an outdated logic that leads to incorrect output.", QuestionSolutionDetail = "Revise the logic to ensure it follows the proper algorithmic steps.", QuestionNumber = 2, Score = 9, CreateDate = DateTime.Now, UpdateDate = DateTime.Now },
            new Report { ReviewId = 3, ExamId = 3, UserId = 7, ReportContent = "In PRN221, question 3 incorrectly defines the concept of asynchronous programming.", QuestionSolutionDetail = "Update the definition to clarify that asynchronous programming allows multiple tasks to run concurrently without blocking.", QuestionNumber = 3, Score = 8, CreateDate = DateTime.Now, UpdateDate = DateTime.Now },
